            ...
            <div class="cart-item-left">
                ...
                <div class="cart-item-details">
                    <form action="product-details.php" method="GET">
                        <!-- Use dynamic product_id here -->
                        <input type="hidden" name="id" value="<?php echo $cartItem['id']; ?>"> <!-- Make sure 'id' is part of $cartItem -->
                        <button type="submit" class="product-button"><?php echo htmlspecialchars($cartItem['name']); ?></button>
                    </form>
                </div>
            </div>
