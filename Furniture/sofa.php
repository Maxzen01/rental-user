...
$category = 'sofa'; // Define the category for this page
...
/* Image Styles */
.product-item img {
    max-width: 100%; /* Ensure the image width fits the card */
    ...
    <main>
        <section class="product-list">
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p style="text-align:center;">No sofa products available at the moment.</p>
            <?php endif; ?>
        </section>
    </main>
    ...
    <div class="footer">
        ...
        <div>
            ...
            <ul style="list-style: none; padding: 0;">
                <li><a href="/Rental/admin/Furniture/furniture.php" style="text-decoration: none; color: inherit;">Furniture Rentals</a></li>
                <li><a href="/Rental/admin/Appliances/appliances.php" style="text-decoration: none; color: inherit;">Appliances Rentals</a></li>
                <li><a href="/Rental/admin/Apartments/apartment.php" style="text-decoration: none; color: inherit;">Apartment Rentals</a></li>
                <li><a href="/Rental/admin/sports/sport.php" style="text-decoration: none; color: inherit;">Sports Equipment Rentals</a></li>
                <li><a href="/Rental/admin/bike/bike.php" style="text-decoration: none; color: inherit;">Vehicles Rentals</a></li>
            </ul>
        </div>
            <div>
                <h3>Contact</h3>
                <p>Email: vinuthnakumarmaxzen08@gmail.com</p>
                <p>Phone: +91 9014908994</p>
            </div>
        </div>
