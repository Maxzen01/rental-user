...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO appartments (product_name, company_name, main_photo, several_photos, description, monthly_price, contact_number, category, location) 
  ...
  <div class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select id="product-category" name="product-category" required>
        ...
        <option value="appartment2">appartments</option>
        <option value="1bhk">1BHK</option>
        <option value="2bhk">2BHK</option>
        <option value="villa">Hostel</option>
        <option value="hostel">villa</option>
      </select>
