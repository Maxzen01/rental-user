...
$category = 'appartment2'; // Define the category for this page
...
<head>
    ...
    <title>Appartment Products</title>
    ...
    <main>
        <section class="product-list">
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p style="text-align:center;">No Appartment products available at the moment.</p>
            <?php endif; ?>
        </section>
    </main>
