...
$category = 'volleyball'; // Define the category for this page
$sql = "SELECT * FROM sports WHERE category = '$category'";
...
<head>
    ...
    <title>Volley ball Products</title>
    ...
    <main>
        <section class="product-list">
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p style="text-align:center;">No volleyball products available at the moment.</p>
            <?php endif; ?>
        </section>
    </main>
