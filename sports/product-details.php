...
$productName = isset($_GET['name']) ? urldecode($_GET['name']) : 'Unknown Product';
$productSource = isset($_GET['source']) ? urldecode($_GET['source']) : 'Unknown Source';

// Example: Fetch product details based on $productName and $productSource
// Here, you'd usually query the database or an array of products.

echo "<h1>Product Details</h1>";
echo "<p>Product Name: " . htmlspecialchars($productName) . "</p>";
echo "<p>Source Category: " . htmlspecialchars($productSource) . "</p>";
