...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO appliances (product_name, company_name, main_photo, several_photos, description, monthly_price, contact_number, category, location) 
...
<body>
  <div class="container">
    ...
    <div class="back-button">
      <a href="appliances.php">Back to Home</a>
    </div>
  </div>
</body>
</html>
