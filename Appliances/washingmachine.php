...
$category = 'washingmachine'; // Define the category for this page
$sql = "SELECT * FROM appliances WHERE category = '$category'";
...
<head>
    ...
    <title>Washing Machine Products</title>
    ...
    <main>
        <section class="product-list">
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p style="text-align:center;">No Washing Machine Products available at the moment.</p>
            <?php endif; ?>
        </section>
    </main>
